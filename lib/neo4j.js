...
module.exports = {
  ...
  reset() {
    if (!_.isNil(this.driver) || !_.isNil(this.drivers)) {
      ...
      console.warn('Seems like you\'re resetting while the drivers are not set. This should not be the case if you don\'t what you\'re doing.');
      this.driver = undefined;
      this.drivers = undefined;
