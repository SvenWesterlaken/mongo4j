...
module.exports = {
  ...
  init(hosts, auth, options) {
    ...
    if (_.isArray(hosts) && (_.isNull(this.driver) || _.isUndefined(this.driver)) && (_.isNull(this.drivers) || _.isUndefined(this.drivers))) {
      ...
      this.drivers = _.map(hosts, (host) => {
        ...
        if (_.isNull(host.name) || _.isUndefined(host.name)) {
    ...
    if ((_.isNull(this.driver) || _.isUndefined(this.driver)) && (_.isNull(this.drivers) || _.isUndefined(this.drivers))) {
    ...
    if (!_.isNull(this.driver) && !_.isUndefined(this.driver)) {
      throw new TypeError("A driver has already been initialized");
    } else if (!_.isNull(this.drivers) && !_.isUndefined(this.drivers)) {
  ...
  getDriver(identifier) {
    ...
    if ((_.isNull(driver) || _.isUndefined(driver)) && (_.isNull(drivers) || _.isUndefined(drivers))) {
  ...
  close(identifier) {
    ...
    if (!_.isUndefined(this.drivers) && _.isInteger(this.identifier)) {
      ...
      let unclosed_driver = this.drivers[identifier];
      unclosed_driver.close();
    }
